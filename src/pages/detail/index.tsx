...
export function Detail(){
    ...
    useEffect(() => {
        function getData(){
          ...
          fetch(`https://sujeitoprogramador.com/api-cripto/coin?key=9471719e611e0cbf&pref=BRL&symbol=${cripto}`)
          //fetch(`https://coinlib.io/api/v1/coin?key=9471719e611e0cbf&pref=BRL&symbol=${cripto}`)       
